...
\item
  ...
  distribuição qui-quadrado, que é contínua \autocite{barbetta1988}.
\item
...
\begin{longtable}[]{@{}lll@{}}
\caption{\label{tab:tamprop}Situação do peso de cobaias do estudo antes e
...
{\centering \includegraphics[width=\textwidth]{correlacao1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/unnamed-chunk-128-1} 
...
{\centering \includegraphics[width=\textwidth]{regress1} 
...
{\centering \includegraphics[width=\textwidth]{regress2} 
...
expresso da seguinte maneira \autocite{hoffmann1998}:
...
a \(b_1\) e podem ser descritas por \autocite{hoffmann1998}:
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/unnamed-chunk-132-1} 
...
\(\varepsilon = y -\hat{y}\) \autocite{barbetta1988}.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\StringTok{"residuos1.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=\textwidth]{residuos1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/residuos1-1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/residuos2-1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/qqnorm-1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/unnamed-chunk-135-1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/residpad-1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/residst-1} 
...
{\centering \includegraphics[width=\textwidth]{index_files/figure-latex/ptoinf-1} 

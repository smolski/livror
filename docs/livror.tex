...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-171-1} 

}

\caption{Reta de regressão ajustada da nota em relação ao tempo de estudo dos participantes da pesquisa}\label{fig:unnamed-chunk-171}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-173-1} 

}

\caption{Histograma de distribuição da probabilidade para os resíduos}\label{fig:unnamed-chunk-173}
\end{figure}

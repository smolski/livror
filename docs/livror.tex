...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-101-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-102-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-103-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-104-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-106-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-107-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-108-1} 

}

\caption{Histograma com a variável `Renda h`}\label{fig:unnamed-chunk-108}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-109-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-110-1} \end{center}
...
\caption{\label{tab:reg1}Relação entre o tempo de estudo e a nota.}\tabularnewline
\toprule
...
\texttt{plot(variável\_preditora,\ variável\_dependente}
...
\texttt{cor(variável\_preditora,variável\_dependente)} ou \texttt{cor(x,y)}
...
\begin{center}\includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-172-1} \end{center}
...
No software R, utiliza-se a função \texttt{anova()} para obter a análise de variância informando o nome dado ao modelo de regressão, obtido anteriormente.
...
No software R, o valor do coeficiente de determinação é obtido pelo comando \texttt{summary()}, conforme segue:
...
\KeywordTok{abline}\NormalTok{(}\KeywordTok{coef}\NormalTok{(regressaolinear))}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-175-1} 

}

\caption{Reta de regressão ajustada da nota em relação ao tempo de estudo dos participantes da pesquisa}\label{fig:unnamed-chunk-175}
\end{figure}
...
\KeywordTok{plot}\NormalTok{(tempo, }\KeywordTok{residuals}\NormalTok{(regressaolinear), }
     \DataTypeTok{xlab =} \StringTok{"Valores independentes"}\NormalTok{,}
...
\texttt{residuals(regressaolinear)} (exibe os resíduos do modelo regressao).

\texttt{fitted(regressaolinear)} (exibe os valores ajustados do modelo regressao).
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-177-1} 

}

\caption{Histograma de distribuição da probabilidade para os resíduos}\label{fig:unnamed-chunk-177}
\end{figure}

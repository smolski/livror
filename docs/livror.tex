...
\caption{Gráfico de linha sobre as temperaturas registradas em São Luiz Gonzaga - RS}\label{fig:unnamed-chunk-84}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-136-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-140-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-143-1} 

...
Variáveis reporta-se a características ou atributos que podem tomar diferentes valores ou categorias, o que se opõe ao conceito de constante (ALMEIDA; FREIRE, \protect\hyperlink{ref-almeida2000}{2000}). Assim, variável pode ser definida como sendo a característica dos elementos da amostra ou da população que nos interessa estudar estatisticamente.
...
\caption{Gráfico de colunas com a variável Sexo (Horizontal)}\label{fig:unnamed-chunk-68}
\end{figure}
...
\caption{Gráfico de colunas com a variável `Pessoas familia`}\label{fig:unnamed-chunk-69}
\end{figure}
...
\caption{Gráfico de colunas com as variáveis Sexo e Divulgacao}\label{fig:unnamed-chunk-70}
\end{figure}
...
\caption{Gráfico de colunas com as variáveis Sexo e Divulgacao (2)}\label{fig:unnamed-chunk-72}
\end{figure}
...
\caption{Gráfico de pizza com a variável Sabor}\label{fig:unnamed-chunk-73}
\end{figure}
...
\caption{Histograma com a variável `Renda h`}\label{fig:unnamed-chunk-74}
\end{figure}
...
\caption{Histograma com a variável Renda h com breaks=5}\label{fig:unnamed-chunk-75}
\end{figure}
...
\caption{Boxplot com a variável Idade}\label{fig:unnamed-chunk-77}
\end{figure}
...
\caption{Gráfico de linha sobre a fiscalização do trabalho na área rural Brasil 1998-2010}\label{fig:unnamed-chunk-80}
\end{figure}
...
\caption{Gráfico de linha sobre as temperaturas registradas em São Luiz Gonzaga - RS}\label{fig:unnamed-chunk-82}
\end{figure}
...
A inferência estatística, ou estatística inferencial, tem por objetivo concluir e tomar decisões, com base em amostras (Figura \ref{fig:infestat}). Usam-se dados extraídos de uma amostra para produzir inferência sobre a população (LOPES et al., \protect\hyperlink{ref-lopes2008}{2008}).
...
\caption{\label{tab:unnamed-chunk-115}Amostras dependentes}
\centering
...
\caption{\label{tab:unnamed-chunk-117}Amostras dependentes - caso 2}
\centering
...
\caption{\label{tab:unnamed-chunk-119}Comparação de dois tipos diferentes de tecidos}
\centering
...
\caption{Diagrama de dispersão da nota em relação ao tempo de estudo dos participantes do estudo}\label{fig:unnamed-chunk-134}
\end{figure}
...
\caption{Reta de regressão ajustada da nota em relação ao tempo de estudo dos participantes da pesquisa}\label{fig:unnamed-chunk-138}
\end{figure}
...
\caption{Histograma de distribuição da probabilidade para os resíduos}\label{fig:unnamed-chunk-141}
\end{figure}
...
Seguem algumas importantes opções das Chunks dos arquivos RMarkdown (ALLAIRE et al., \protect\hyperlink{ref-R-rmarkdown}{2017}):

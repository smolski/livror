...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-71-1} 
...
\caption{Gráfico de pizza com a variável Sabor}\label{fig:unnamed-chunk-74}
\end{figure}
...
\begin{center}\includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-77-1} \end{center}
...
\caption{Gráfico de linha sobre a fiscalização do trabalho na área rural Brasil 1998-2010}\label{fig:unnamed-chunk-81}
\end{figure}
...
\caption{Gráfico de linha sobre as temperaturas registradas em São Luiz Gonzaga - RS}\label{fig:unnamed-chunk-83}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-116}Amostras dependentes}
\centering
...
\caption{\label{tab:unnamed-chunk-118}Amostras dependentes - caso 2}
\centering
...
\caption{\label{tab:unnamed-chunk-120}Comparação de dois tipos diferentes de tecidos}
\centering
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-135-1} 

}

\caption{Diagrama de dispersão da nota em relação ao tempo de estudo dos participantes do estudo}\label{fig:unnamed-chunk-135}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-139-1} 

}

\caption{Reta de regressão ajustada da nota em relação ao tempo de estudo dos participantes da pesquisa}\label{fig:unnamed-chunk-139}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{index_files/figure-latex/unnamed-chunk-142-1} 

}

\caption{Histograma de distribuição da probabilidade para os resíduos}\label{fig:unnamed-chunk-142}
\end{figure}
